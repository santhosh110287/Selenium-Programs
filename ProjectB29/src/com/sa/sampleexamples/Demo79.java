...
/* Get options Program in drop down for all options using String array and for loop
...
public class Demo79 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		for(int i=0;i<3;i++)
		{
//			String loc_value="A"+i; //Input is in sequential order(A1,A2,A3) if yes then we can write program like Demo78 or if it is not in sequential(A1,B2,C3) then we can write the program like Demo79
			System.out.println("ListBox:"+loc_values[i]);
			WebElement listbox = driver.findElement(By.id(loc_values[i]));//find the element and give it to select class
