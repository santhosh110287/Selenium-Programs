...
public class Demo76 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		WebElement listbox = driver.findElement(By.id("A1"));//address of A1 will be stored in the variable listbox
		...
		WebElement first = select.getFirstSelectedOption();//address of first option will be stored in first
