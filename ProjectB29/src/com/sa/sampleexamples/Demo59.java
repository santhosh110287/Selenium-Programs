...
// Select all the checkbox using for each loop
public class Demo59 {
	...
	public static void main(String[] args) throws InterruptedException { 
		...
		//Alternative check box selection
		List<WebElement> alternativeCheckBox = driver.findElements(By.xpath("(//input[@type='checkbox'])[position() mod 2=0]"));
		for (WebElement chkBox : alternativeCheckBox) 
		{
			chkBox.click();
			Thread.sleep(1000);
		}
