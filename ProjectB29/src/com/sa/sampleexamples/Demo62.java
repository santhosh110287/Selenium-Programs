...
// Handle Auto suggestions in the amazon
...
public class Demo62 {
	...
	public static void main(String[] args) throws InterruptedException { 
		...
		//driver.switchTo().activeElement().sendKeys("java"); //Sendkeys to amazon using active element method
		driver.findElement(By.id("twotabsearchtextbox")).sendKeys("redmi");//Sendkeys to amazon using find element method
		Thread.sleep(3000);
		String xp = "//div[@class='s-suggestion']";
