...
public class Demo55 {
	...
	public static void main(String[] args) throws InterruptedException { 
		...
		//Demo54 class program written using Using foreach loop
		//here enter name in all text box and later it clear all the text box
		...
		//Clear all the fields in reverse order
