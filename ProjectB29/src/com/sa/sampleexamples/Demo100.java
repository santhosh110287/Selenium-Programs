//17-02-2022
//Print title of each browser(all the windows) using getWindlowHandles  and closes each browser
...
public class Demo100 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//Print title of each browser(all the windows) and closes each browser
		for (String w : allWHS) 
		{
