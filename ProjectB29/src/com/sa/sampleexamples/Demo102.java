//17-02-2022
//Closing all the child browser except parent browser
...
public class Demo102 {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		String wh = driver.getWindowHandle();//return window handle of current browser i.e Parent browser(GUI1 and will store in wh)
		...
		allWHS.remove(wh);//Remove parent browser from java memory not from desktop and keep only child browser
